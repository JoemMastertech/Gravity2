...
const ProductRenderer = {
  ...
  createProductGrid: function (container, data, fields, categoryTitle) {
    ...
    wrapper.className = 'grid-view-container';
  ...
  renderLicores: async function (container) {
    ...
    const licoresHTML = `
      <div class="grid-view-container">
        ...
        <div class="subcategory-prompt" style="width: 100%; text-align: center; margin-top: 20px;">
          <h3 class="page-title" style="font-size: 1.5rem; opacity: 0.9;" data-translate="category.prompt.choose" data-original-text="Elige una categoría" data-namespace="categories">Elige una categoría</h3>
        </div>
      </div>
    `;
